...
var rules = []*Rule{
	...
	{2, "", true, false, "友善溝通，禁止言語怒罵，例: 問候、歧視、嘲諷等"},
	{3, "", true, false, "Driver Station內限制最多三人(driver, driver, coach)"},
	...
	{11, "", true, false, "比賽結果由裁判評分，請尊重裁判判決"},
	{12, "", false, false, "每台機器人至多攜帶3個場地物件,超過五秒視為犯規"},
	{13, "", true, false, "機器人或機器人上的物件觸碰到 Trap"},
	{14, "", true, false, "機器人或機器人上的物件在非 Endgame 時觸碰到 Cube"},
}
